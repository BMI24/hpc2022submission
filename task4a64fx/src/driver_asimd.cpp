...
#pragma omp parallel
  ...
  benchmark("peak_asimd_fmla_sp", peak_asimd_fmla_sp, l_n_repetitions, l_n_threads);
  benchmark("peak_asimd_fmla_dp", peak_asimd_fmla_dp, l_n_repetitions, l_n_threads);
  benchmark("peak_asimd_fmadd_sp", peak_asimd_fmadd_sp, l_n_repetitions, l_n_threads);
  benchmark("peak_asimd_fmadd_dp", peak_asimd_fmadd_dp, l_n_repetitions, l_n_threads);
