...
int main() {
  ...
  double l_g_flops = 0;
  int l_n_threads = 1;
  uint64_t l_n_repetitions = 100000000;
...
#pragma omp parallel
  ...
  /*
   * Peak ASIMD soruce-dependent FMLA SP
   */
...
#pragma omp master
  ...
  std::cout << "  GFLOPS: " << l_g_flops << std::endl;
    ...
    /*
   * Peak ASIMD source-dependent FMUL SP
   */
...
#pragma omp master
  ...
  std::cout << "  GFLOPS: " << l_g_flops << std::endl;
   ...
   /*
   * Peak ASIMD destination-dependent FMLA SP
   */
...
#pragma omp master
  ...
  /*
   * Peak ASIMD destination-dependent FMUL SP
   */
